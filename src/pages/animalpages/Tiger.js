    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/shelter-2e669.appspot.com/o/animal_pics%2FTiger.jpeg?alt=media&token=d9ddc338-1911-4586-adbd-8b4b143feb48)',
        ...
        <Typography variant="h6">Age: 6</Typography>
