    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/shelter-2e669.appspot.com/o/animal_pics%2FReks.jpeg?alt=media&token=2f287008-e6df-47e7-a943-290b88b915a3)',
        ...
        <Typography variant="h6">Age: 5</Typography>
