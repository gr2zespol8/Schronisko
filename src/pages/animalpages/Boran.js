    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/shelter-2e669.appspot.com/o/animal_pics%2FBoran.jpeg?alt=media&token=d22b2f93-309f-4a8a-9682-0334de7ac14b)',
        ...
        <Typography variant="h6">Age: 4</Typography>
