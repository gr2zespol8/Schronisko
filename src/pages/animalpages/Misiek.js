...
export default function Misiek() {
    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/shelter-2e669.appspot.com/o/animal_pics%2FMisiek.jpeg?alt=media&token=3a860b41-a902-4e63-9788-9de81aa9510a)',
        ...
        <Typography variant="h6">Age: 1</Typography>
