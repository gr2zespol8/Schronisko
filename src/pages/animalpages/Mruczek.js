...
export default function Mruczek() {
    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/shelter-2e669.appspot.com/o/animal_pics%2FMruczek.jpeg?alt=media&token=93bb1d66-e2b4-4216-9e24-eeb2c56c3085)',
